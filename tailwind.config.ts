...
// Canopy design system — shared verbatim with the farmer & platform panels so the
// three frontends look like one product. Theme: Organic Biophilic, "warm paper"
// light base + a single confident green accent, warm amber used sparingly.
  ...
  theme: {
    extend: {
      colors: {
        ...
        cta: { DEFAULT: '#15803D', hover: '#166534' }, // green — Buy / Retire CTAs
        ...
        state: {
          verified: '#15803D', // green — verified / listed-ok / retired
